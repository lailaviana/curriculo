...
cv_url <- "https://docs.google.com/spreadsheets/d/1bba2VZvhMHt_JwibQ8XK9ettFwJMzxyYqhlPra4RNXE/edit?usp=sharing"
...
Bióloga com larga experiência em pesquisa em biologia molecular e bioinformática. Desenvolve atividades de pesquisa laboratorial e tem experiência com diagnóstico molecular e sorológico e sequenciamento de nova geração.

### Idiomas

**Português:** Fluente <br> **Inglês:** Avançado <br>

### Prêmios

<i class="far fa-star"></i> Relevância Acadêmica (UFMG) - 2014/2015

<i class="far fa-star"></i> Zigman Brener Award (SBPz) - 2015

<i class="far fa-star"></i> Walter Colli Award (SBPz) - 2016/2018 (Co-autora)

<i class="far fa-star"></i> Menção Honrosa (X-meeting) - 2016 (Co-autora)
...
## <i class="fa-solid fa-graduation-cap"></i> Escolaridade

```{r}
create_section(cv, "education")
```

## <i class="fa-solid fa-flask-vial"></i> Habilidades

```{r}
create_section(cv, "lab_skills")
```

## <i class="fa-solid fa-newspaper"></i> Publicações

```{r}
create_section(cv, "publications_journals")
```

## <i class="fa-solid fa-chalkboard-user"></i> Cursos de Curta Duração
...
Currículo feito com [Quarto](https://quarto.org/). Atualizado pela última vez em `r format.Date(Sys.Date(), "%b %d, %Y")`. <br>License: [CC BY-SA 2.0](https://creativecommons.org/licenses/by-sa/2.0/).
